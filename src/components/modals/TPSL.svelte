...
<Modal title="Set Take Profit / Stop Loss" width={320}>
  <div class="container">
    ...
    <div class="tpsl-toggle-description-container">
      <div class="tpsl-toggle-description">Toggle between Long and Short modes to estimate profit/loss levels.</div>
    ...
    <div class="tpsl-container-flex">
      <div class="input-container-tpsl">
        ...
        <div class="input-gain-loss">
          <label for="Gain" class="prefix"> Gain </label>
          ...
          <label for="Gain" class="suffix"> % </label>
        </div>
      </div>
      <div class="input-container-tpsl">
        <Input label={"SL"} bind:value={$slPrice} />
        <div class="input-gain-loss">
          <label for="Loss" class="prefix"> Loss </label>
          ...
          <label for="Loss" class="suffix"> % </label>
        </div>
      </div>
    </div>
